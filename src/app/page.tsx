...
import { WorkflowDiagram } from "@/components/infographics/WorkflowDiagram";
                ...
                steps={[
                  {
                    ...
                    description: "Tell your AI team what you need",
                    color: "#5E6AD2",
                  },
                  {
                    number: 2,
                    title: "Review & Approve",
                    description: "See everything before approving",
                    color: "#5E6AD2",
                  },
                  {
                    number: 3,
                    title: "Watch It Run",
                    description: "Track everything in Activity Hub",
                    color: "#5E6AD2",
                  },
                ]}
              />
                ...
                <CardContent className="p-8">
                  ...
                  <div className="mt-6 space-y-6">
                    <div className="flex items-start gap-4">
                      <QubikIcon size={48} />
                      <div>
                        <h4 className="font-semibold text-[#DC2626]">Qubik (Creative Motor)</h4>
                    ...
                    <div className="flex items-start gap-4">
                      <ThemisIcon size={48} />
                      <div>
                        <h4 className="font-semibold text-[#9333EA]">Themis (Logic Motor)</h4>
                    ...
                    <div className="flex items-start gap-4">
                      <CoreIcon size={48} />
                      <div>
                        <h4 className="font-semibold text-[#3B82F6]">Core (Guide)</h4>
