...
export const metadata: Metadata = {
  ...
  description: "Complete glossary of ANOTS terminology: ANOT, Brand Archaeologist, TCAM V3, Qubik, Themis, Athena, Hephaestus, Brand Room, Activity Hub, approval workflows, and AI marketing automation concepts. Understand every term used in the ANOTS platform.",
...
const glossaryTerms: GlossaryTerm[] = [
  ...
  {
    term: "TCAM V3",
    definition: "Four-Agent Collaborative Architecture Model Version 3. The enhanced AI system powering ANOTS, consisting of four specialized agents: Qubik (Creative Motor), Themis (Analytical Motor), Athena (Synthesizer), and Hephaestus (ANOT Maker). This architecture ensures creative ideas are balanced with analytical rigor and practical implementation.",
    category: "Core Concepts",
    relatedTerms: ["Qubik", "Themis", "Athena", "Hephaestus"],
  },
  {
    term: "Qubik",
    ...
    category: "AI Agents",
    relatedTerms: ["TCAM V3", "Themis", "Athena", "Hephaestus"],
  },
  {
    term: "Themis",
    ...
    category: "AI Agents",
    relatedTerms: ["TCAM V3", "Qubik", "Athena", "Hephaestus"],
  },
  {
    term: "Athena",
    definition: "The Synthesizer in TCAM V3. Athena combines perspectives from Qubik and Themis into clear recommendations presented to you for approval. Uses AI models like DeepSeek R1 (Free), Gemini 3 Flash (Standard), or Gemini 3 Pro (Pro). Acts as the central decision support system. Named after the Greek goddess of wisdom and strategic warfare.",
    category: "AI Agents",
  ...
  },
  {
    ...
    category: "AI Agents",
    relatedTerms: ["TCAM V3", "Qubik", "Themis", "Athena", "ActivePieces"],
  },
  {
  ...
  },
  {
    ...
    definition: "The review process where nothing runs without your explicit permission. Process: (1) You chat with AI team, (2) Qubik creates proposal, (3) Themis reviews for risks, (4) Athena synthesizes recommendation, (5) Hephaestus builds the flow, (6) You approve or reject. Ensures full control over all marketing automation.",
    category: "Core Concepts",
    relatedTerms: ["TCAM V3", "ANOT", "Risk Detection", "Hephaestus"],
  },
  {
    term: "AI Council",
    definition: "The collective decision-making body of Qubik, Themis, Athena, and Hephaestus. Reviews all Brand Archaeologist extractions and creates unified brand snapshots. Ensures multi-perspective validation before committing brand data.",
    category: "AI Agents",
