...
export const pricingTiers: PricingTierData[] = [
  {
    ...
    features: [
      ...
      { name: 'MAGIC Import: Gemini 2.0 Flash (Brand extraction)', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'MAGIC Import: Gemini 1.5 Pro (Advanced brand extraction)', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'MAGIC Import: Gemini 1.5 Pro (Premium brand extraction)', included: true },
